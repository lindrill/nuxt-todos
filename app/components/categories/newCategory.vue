            ...
            <q-form @submit="saveNewCategory">
                <q-card-section class="q-mx-md">
                    ...
                    <div class="q-my-sm">
                        ...
                        <q-input filled v-model="newCategory.title" color="amber-6" lazy-rules :rules="[rules.required]"/>
                    </div>
                    <div class="q-my-sm">
                ...
                <q-card-actions align="right" class="q-pa-lg">
                    <q-btn flat label="Cancel" color="amber-6" text-color="black" :loading="submitting" :disable="submitting" @click="cancelNewCategoryDialog"/>
